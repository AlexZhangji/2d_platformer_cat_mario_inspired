	...
	public void calculateCorners(double x, double y) {
		...
		int bottomTile = (int)(y + cheight / 2 - 1) / tileSize;
		  ...
		  if(topTile < 0 || bottomTile >= tileMap.getNumRows() ||
	                ...
	                System.out.println("a dead girl appear");
	               
	    			Sound.playMusic("./Resources/SoundEffects/DeathBGM.wav", "play");
	...
	public void checkTileMapCollision() {
		...
		if(dy > 0) {
			if(bottomLeft || bottomRight) {
				...
				int rc = tileMap.map[currRow+1][currCol];
				int r = rc /21;
				int c = rc % 21;
				...
				if(tileMap.tiles[r][c].isTrap(	))
				{
					...
					System.out.println("hit Button Trap!  curRow = " + currRow + "  ,  currCol = " + currCol + ". tile type : " +  tileMap.tiles[r][c].getTrapType());		
					GameOnState.player.TrapEffects(type);
				}
